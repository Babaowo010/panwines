    ...
    return (
        <div>
            ...
            {/* <form onSubmit={handleSubmit}> */}
                <div onSubmit={handleSubmit} className="container2">
                <input
                    className="input"
                ...
                <button className="submitb "> <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div onSubmit={handleSubmit} className="container3">
                <input
                     className="input"
